...
RTC6705 (SSOP-24)        STM32F030F4P6 (TSSOP-20)
------------------       ------------------------
PIN 1  (VCC1)    ------> 3.3V
PIN 2  (GND1)    ------> GND
PIN 7  (MOD_IN)  <------ Видео вход (через C6 100nF)
PIN 10 (RF_OUT)  ------> Антенна (через C7 1pF)
PIN 14 (CE)      <------ PA4 (любой GPIO)
PIN 15 (CLK)     <------ PA5 (SPI1_SCK)
PIN 16 (DATA)    <------ PA7 (SPI1_MOSI)
PIN 17 (LE)      <------ PA6 (любой GPIO)
PIN 22 (OSC_IN)  ------> Кварц 20 МГц
PIN 23 (OSC_OUT) ------> Кварц 20 МГц
PIN 8  (VCC_MOD) ------> 3.3V (отдельно через C8 100nF)
PIN 11 (VCC_RF)  ------> 3.3V (отдельно через C9 100nF)